  ...
  return (
    <div className="max-w-xl mx-auto px-6 py-10 pb-32 flex flex-col gap-10">
      ...
      <section className="flex flex-col gap-3">
        ...
        <div className="rounded-xl border border-slate-200 dark:border-stone-700 bg-white dark:bg-zinc-800 overflow-hidden divide-y divide-slate-100 dark:divide-stone-700">
          {members.map((m, i) => {
      ...
      <section className="flex flex-col gap-3">
        ...
        <div className="rounded-xl border border-red-200 dark:border-red-900 bg-white dark:bg-zinc-800 px-4 py-3 flex items-center justify-between">
          <div>
